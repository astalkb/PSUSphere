...
urlpatterns = [
    ...
    path('radarChartOrgParticipation/',
         RadarChartOrgParticipation, name='radar-chart'),
    path('bubbleChartStudentPrograms/',
         BubbleChartStudentPrograms, name='bubble-chart'),
    path('horizontalBarTopOrgs/', HorizontalBarTopOrganizations,
         name='horizontal-bar-chart'),
    path('stackedBarOrgMemberTrends/',
         StackedBarOrgMemberTrends, name='stacked-bar-chart'),
    path('doughnutProgramDistribution/',
         DoughnutProgramDistribution, name='doughnut-chart'),
